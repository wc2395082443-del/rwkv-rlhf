...
OUT=/root/autodl-tmp/deepmath_clean_gsm8k_grpo_g1f1p5b_step300_20260713
MODEL=/root/autodl-tmp/deepmath_clean_gsm8k_grpo_g1f1p5b_20step_20260713/final_step_20.pth
...
cp /root/autodl-tmp/run_deepmath_resume_to300_20260713.sh "$OUT/run.sh"
echo "[$(date '+%F %T')] START global_step=20 target_step=300" | tee "$OUT/status.log"
...
/root/miniconda3/bin/python train_rl_deepmath_resume.py \
  ...
  --grad_cp 1 --total_steps 280 --step_offset 20 --random_seed 43 \
