...
class GRPOConfig:
    ...
    hard_buffer_hard_ratio: float = 0.5
...
class GRPOTrainer:
    ...
    def train_step(self, step: int) -> Dict[str, Any]:
        ...
        hard_ratio = min(1.0, max(0.0, float(self.cfg.hard_buffer_hard_ratio)))
        hard_needed_questions = int(round(needed_questions * hard_ratio))
        if hard_ratio > 0.0:
            hard_needed_questions = max(1, hard_needed_questions)
        hard_needed_questions = min(needed_questions, hard_needed_questions)
