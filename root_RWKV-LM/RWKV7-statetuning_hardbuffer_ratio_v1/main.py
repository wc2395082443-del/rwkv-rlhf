...
def parse_args():
    ...
    ap.add_argument("--hard_buffer_hard_ratio", type=float, default=0.5, help="fraction of hard-buffer questions in each extra step")
...
def main():
    ...
    cfg = GRPOConfig(
        ...
        hard_buffer_hard_ratio=float(args.hard_buffer_hard_ratio),
