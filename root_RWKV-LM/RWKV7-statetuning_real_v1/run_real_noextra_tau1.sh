...
base=/root/RWKV-LM/RWKV7-statetuning_real_v1/log/real_noextra_tau1_$(date +%Y%m%d_%H%M%S)
mkdir -p "$base"

echo "$base" > /root/RWKV-LM/RWKV7-statetuning_real_v1/log/latest_real_noextra_tau1.txt
