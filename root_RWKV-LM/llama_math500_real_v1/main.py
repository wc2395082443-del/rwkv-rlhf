...
def parse_args():
    ...
    ap.add_argument('--policy_objective', type=str, default='grpo', choices=['grpo', 'real'])
    ap.add_argument('--real_tau', type=float, default=0.5)
    ap.add_argument('--real_label_source', type=str, default='reward', choices=['reward', 'correct'])
    ap.add_argument('--real_reward_weight_cap', type=float, default=2.0)
