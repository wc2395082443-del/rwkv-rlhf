...
def parse_args():
    ...
    ap.add_argument('--ga_enable', action='store_true')
    ap.add_argument('--ga_mode', type=str, default='full', choices=['full', 'lite'])
    ap.add_argument('--ga_val_size', type=int, default=64)
    ap.add_argument('--ga_selection_interval', type=int, default=10)
    ap.add_argument('--ga_candidate_pool_size', type=int, default=96)
    ap.add_argument('--ga_selection_ratio', type=int, default=4)
    ap.add_argument('--ga_val_rollouts', type=int, default=8)
    ap.add_argument('--ga_candidate_rollouts', type=int, default=4)
    ap.add_argument('--ga_candidate_keep_ratio', type=float, default=0.5)
    ap.add_argument('--ga_score_threshold', type=float, default=-1.0)
    ap.add_argument('--ga_grad_batch_questions', type=int, default=4)
    ap.add_argument('--ga_max_new_tokens', type=int, default=256)
    ap.add_argument('--ga_main_buffer_ratio', type=float, default=0.25)
    ap.add_argument('--ga_extra_top_ratio', type=float, default=0.5)
    ap.add_argument('--ga_hard_target_size', type=int, default=16)
    ap.add_argument('--ga_train_keep_ratio', type=float, default=0.25)
