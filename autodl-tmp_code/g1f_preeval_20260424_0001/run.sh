...
exec /root/miniconda3/bin/python /root/RWKV-LM/RWKV-v7/train_temp/train_rl_baseline.py \
  ...
  --proj_dir /root/autodl-tmp/g1f_preeval_20260424_0001/run \
  ...
  --total_steps 0 --num_questions 24 --samples_per_question 8 --max_new_tokens 768 \
  ...
  --skip_preeval 0 --preeval_sample_ratio 1.0 --skip_posteval 1 --eval_interval 0 --save_interval 0 \
  ...
  --extra_curriculum off --full_eval_early_stop_patience 0 --save_eval_checkpoint 0 --save_final_checkpoint 0 
