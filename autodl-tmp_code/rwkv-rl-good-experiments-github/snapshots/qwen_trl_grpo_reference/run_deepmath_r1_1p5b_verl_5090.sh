...
OUT_DIR=${OUT_DIR:-/root/autodl-tmp/trl-grpo-repro/verl_outputs/deepmath_r1_1p5b_5090}
...
python -m verl.trainer.main_ppo \
  ...
  algorithm.filter_groups.max_num_gen_batches=12 \
  ...
  trainer.experiment_name='deepseek_r1_qwen_1p5b_5090' \
