...
OUT_DIR=${OUT_DIR:-/root/autodl-tmp/trl-grpo-repro/verl_outputs/deepmath_r1_1p5b_5090_vllm_smoke}
...
python -m verl.trainer.main_ppo \
  ...
  +actor_rollout_ref.actor.optim.name=sgd \
  ...
  custom_reward_function.overlong_buffer.len=256 \
  custom_reward_function.overlong_buffer.penalty_factor=1.0 \
  trainer.project_name=deepmath_official_like \
  trainer.experiment_name=deepseek_r1_qwen_1p5b_5090_vllm_smoke \
