...
exec /root/miniconda3/bin/python train_rl_baseline.py \
  ...
  --proj_dir /root/autodl-tmp/g1e_purehard_k3_len05_zstd02_lr5e6_20260427_102102/run \
  ...
  --lr 5e-6 --neg_adv_weight 0.6 --kl_coef 0.05 --kl_mode k3_loss \
  ...
  --save_eval_checkpoint 0 --save_final_checkpoint 1 --final_full_eval 1 --disable_extra_step 0 \
  > /root/autodl-tmp/g1e_purehard_k3_len05_zstd02_lr5e6_20260427_102102/run/stdout.log 2>&1
