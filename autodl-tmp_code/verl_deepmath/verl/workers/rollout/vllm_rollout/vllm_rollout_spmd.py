...
class vLLMRollout(BaseRollout):
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        def _to_prompt_id_list(raw_prompt_ids):
            if isinstance(raw_prompt_ids, np.ndarray):
                return raw_prompt_ids.tolist()
        ...
        if 'multi_modal_data' in non_tensor_batch:
            ...
            for raw_prompt_ids, multi_modal_data in zip(non_tensor_batch.pop('raw_prompt_ids'),
                ...
                vllm_inputs.append({'prompt_token_ids': _to_prompt_id_list(raw_prompt_ids), 'multi_modal_data': multi_modal_data})
        else:
            vllm_inputs = [{
                'prompt_token_ids': _to_prompt_id_list(raw_prompt_ids)
