...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(self,
        ...
        if role == 'actor' and optim_config is not None:
            ...
            optim_name = str(optim_config.get('name', 'adamw')).lower()
            if optim_name == 'adafactor':
                from transformers import Adafactor
                actor_optimizer = Adafactor(actor_module_fsdp.parameters(),
                                            lr=optim_config.lr,
                ...
                actor_optimizer = bnb.optim.Adam8bit(actor_module_fsdp.parameters(),
                                                     lr=optim_config.lr,
