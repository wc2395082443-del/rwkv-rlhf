...
exec /root/miniconda3/bin/python train_rl_baseline.py \
  ...
  --proj_dir /root/autodl-tmp/g1e_purehard_k3_len05_zstd02_20260427_004729/run \
  ...
  > /root/autodl-tmp/g1e_purehard_k3_len05_zstd02_20260427_004729/run/stdout.log 2>&1
