#!/usr/bin/env bash
set -euo pipefail
cd /root/RWKV-LM/RWKV7-deepmath_trl_doc_g1f1p5b_repro_oldcode_20260628
CUDA_VISIBLE_DEVICES=0 /root/miniconda3/bin/python main.py \
  ...
  --out_dir /root/autodl-tmp/deepmath_repro_oldcode_20260628_075952 \
  --tune_mode full \
  --reward_mode trl_doc \
  --prompt_mode trl_doc \
  --num_questions 8 \
  ...
  --save_last 1 \
  --save_responses 1 \
  --seed 42 2>&1 | tee /root/autodl-tmp/deepmath_repro_oldcode_20260628_075952/train_stdout.log
