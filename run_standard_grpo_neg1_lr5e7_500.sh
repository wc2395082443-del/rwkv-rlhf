...
OUT=/root/autodl-tmp/deepmath_standard_grpo_neg1_g1f1p5b_500_20260715
...
cp /root/autodl-tmp/run_deepmath_standard_grpo_neg1_500_20260715.sh "$OUT/run.sh"
echo "[$(date '+%F %T')] START standard_grpo neg_adv_weight=1.0" | tee "$OUT/status.log"
...
/root/miniconda3/bin/python train_rl_standard_grpo.py \
  ...
  --grad_cp 1 --total_steps 500 --random_seed 42 \
  ...
  --lr 5e-7 --grad_clip 1.0 --neg_adv_weight 1.0 \
